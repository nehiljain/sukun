...
urlpatterns = [
    ...
    # Gmail API endpoints
    path("api/gmail/status", views.GmailStatusView.as_view(), name="gmail_status"),
    path(
        "api/gmail/messages", views.GmailMessagesView.as_view(), name="gmail_messages"
    ),
    path("api/gmail/test", views.GmailTestView.as_view(), name="gmail_test"),
    path(
        "api/gmail/messages/<str:message_id>/archive",
        views.GmailArchiveView.as_view(),
        name="gmail_archive",
    ),
    path("api/gmail/drafts", views.GmailDraftView.as_view(), name="gmail_draft"),
    path(
        "api/gmail/messages/<str:message_id>/important",
